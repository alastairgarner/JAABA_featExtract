function [imageData, alpha] = export_fig_AG(varargin) %#ok<*STRCL1>
%export_fig_AG  Exports figures in a publication-quality format
%
% Examples:
...
%                 % Try using the fig2svg/plot2svg utilities
                try
                    ...
                    [~,icns,~,~] = arrayfun(@legend, ax, 'UniformOutput', false);
                    fig2svg(filename, fig, '', icns);  %https://github.com/kupiqu/fig2svg
                catch
